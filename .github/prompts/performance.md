...
2. `reviewComment` must use GitHub-flavored Markdown. Include the rule ID (e.g. P1, P5) and severity (blocker/warning/nit) at the start. Describe the scale impact.
