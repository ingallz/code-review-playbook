...
2. `reviewComment` must use GitHub-flavored Markdown. Include the rule ID (e.g. C1, C5) and severity (blocker/warning/nit) at the start. Include a concrete failure scenario.
